...
*Screenshots go here  add `ui_shots/true_result.png` and `ui_shots/fake_result.png` below:*
![True prediction example](ui_shots/true_result.png)
![Fake prediction example](ui_shots/fake_result.png)

*(Optional: replace with a short GIF of the app in use.)*
